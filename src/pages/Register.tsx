...
const Register: React.FC = () => {
  ...
  const { registerWithEmail, switchToMockMode, error, clearError, user } = useAuth();
  ...
  return (
    <div className="min-h-[90vh] flex flex-col justify-center items-center px-4 py-12 bg-cyber-black cyber-grid">
      ...
      <div className="mt-8 w-full max-w-md bg-cyber-gray/40 border border-cyber-pink/30 p-4 shadow-lg flex flex-col items-center">
        <div className="flex items-center gap-2 mb-2.5 text-cyber-pink text-xs font-mono uppercase tracking-widest">
